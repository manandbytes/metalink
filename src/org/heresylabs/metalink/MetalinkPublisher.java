 ...
 */
public class MetalinkPublisher {

    protected String name;
    protected String url;

    public MetalinkPublisher(String name, String url) {
        this.name = name;
        this.url = url;
    }

    public MetalinkPublisher() {
    }
    ...
    public boolean equals(Object obj) {
        ...
        final MetalinkPublisher other = (MetalinkPublisher) obj;
